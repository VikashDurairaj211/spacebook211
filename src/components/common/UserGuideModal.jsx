    ...
    topics: [
      {
        ...
        content:
          'Navigate to "Workspace Search" from the sidebar. Use filters at the top to filter by Location (Module 1 / Module 2 - Elcot Park), Date, Time Slots, Capacity range, and specific Amenities.',
        steps: [
