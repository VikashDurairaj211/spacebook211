    ...
    <ToastProvider>
      <div className="flex h-screen w-full flex-col overflow-hidden bg-sky-50/40">
        ...
        <div className="flex flex-1 overflow-hidden relative">
          ...
          {/* Main container handles independent scrolling with matching tint */}
        ...
        {/* SpaceBook Copilot (Only rendered inside authenticated Layout pages) */}
        {isCopilotOpen ? (
